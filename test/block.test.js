suite("Block", function() {
  ...
  test("can attach a toolbar", function() {
    ...
    assert.deepEqual(node, [{tagName: "DIV", content: '<div class="sl-block-content"><p>Test</p></div><ul class="sl-toolbar"><li><a class="move icon-move" title="Move this block arround."></a></li><li class="delimiter"></li><li><a class="remove icon-remove" title="Remove this block."></a></li><li class="delimiter"></li></ul>', type: "textblock"}]);
  });
