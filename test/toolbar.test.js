suite("Toolbar", function() {
  ...
  test("default actions are move and remove", function() {
    ...
    assert.deepEqual(actionNodes, [{tagName: "A", classes: "move icon-move", title: "Move this block arround."}, {tagName: "A", classes: "remove icon-remove", title: "Remove this block."}]);
  });
  ...
  test("can add a edit action", function() {
    ...
    assert.deepEqual(actionNodes, [{tagName: "A", classes: "move icon-move", title: "Move this block arround."}, {tagName: "A", classes: "remove icon-remove", title: "Remove this block."}, {tagName: "A", classes: "edit icon-edit", title: "Can edit this block"}]);
  });
